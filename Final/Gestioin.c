...
ArrayList* Lista_Localidad(ArrayList* this)
{
    ...
    if(this!=NULL)
    {
        ...
        ListOrdenada=al_clone(this); // VER SI EL CLONE HACE NEW
        void* prod;
        if(ListAux !=NULL)
        {
...
ArrayList* gestion_Duplicados(ArrayList* this, int (*pFunc)(void* ,void*))
{
  ...
  //  ArrayList* ListDupl;
    if(this!= NULL && pFunc!=NULL )
    {
        ...
        ListAux->sort(ListAux,compara_elementos_Estructura,0); //ordeno
    }
    return ListAux;
}
...
{//devuelve 1 si estan todas las letras.. 0 si no estan.
    ...
    if(this!=NULL && functionFilter!=NULL && cadLetras!=NULL )
    {
        ...
        for(int i=0;i<strlen(cadLetras);i++)
        {
            ...
            {
                if( al_filter(cadLetras[i],this->get(this,j) )== 0 )
...
int gestion_Existen_Letras(ArrayList* this ,char * cadLetras)
{//devuelve 1 si estan todas las letras.. 0 si no estan.
    ...
    if(this!=NULL  && cadLetras!=NULL )
    {
        ...
        for(int i=0;i<strlen(cadLetras);i++) //recorro la cadena
        {
            ...
            {
                if( gestion_ComparaLetraConLeter(cadLetras[i],ListAux->get(ListAux,j) )== 0 )
                {
                    cont++;
